    ...
    def __init__(self,
        ...
        if self.accelerator.is_main_process:
            ...
            if self.cfg.wandb_name:
                wandb_init_kwargs["name"] = f"{self.cfg.wandb_name}-{cfg_hash[:8]}-seq_len-{self.cfg.model.max_seq_len}-nlatents-{self.cfg.model.num_latents}"
            else:
                wandb_init_kwargs["name"] = f"run-{cfg_hash[:8]}-seq_len-{self.cfg.model.max_seq_len}-nlatents-{self.cfg.model.num_latents}"
